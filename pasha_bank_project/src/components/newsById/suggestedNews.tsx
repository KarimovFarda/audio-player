    ...
    return (
        <aside className="mt-0">
          ...
          <div onClick={() => history.push(`/main/${randomGenerator}`)}>
            <img className="suggested-news-img" src={newsdata && newsdata[randomGenerator - 9].urlToImage}></img>
            <h6>{newsdata && newsdata[randomGenerator - 9].title}
            </h6>
            <div className="small mb-4">Author: {newsdata && newsdata[randomGenerator - 9].author}
            </div>
          </div>
          <div onClick={() => history.push(`/main/${randomGenerator - 1}`)}>
            <img className="suggested-news-img" src={newsdata && newsdata[randomGenerator - 10].urlToImage}></img>
            <h5>{newsdata && newsdata[randomGenerator - 10].title}
            </h5>
            <div className="small mb-4">Author: {newsdata && newsdata[randomGenerator - 10].author}
            </div>
          </div>
          <div onClick={() => history.push(`/main/${randomGenerator + 1}`)}>
            <img className="suggested-news-img" src={newsdata && newsdata[randomGenerator - 8].urlToImage}></img>
            <h5>{newsdata && newsdata[randomGenerator - 8].title}
            </h5>
            <div className="small mb-4">Author: {newsdata && newsdata[randomGenerator - 8].author}
            </div>
          </div>
          <div onClick={() => history.push(`/main/${randomGenerator + 2}`)}>
            <img className="suggested-news-img" src={newsdata && newsdata[(randomGenerator - 7) > 20 ? randomGenerator - 2 : randomGenerator - 7].urlToImage}></img>
            <h5>{newsdata && newsdata[(randomGenerator + 2) > 20 ? randomGenerator - 2 : randomGenerator - 7].title}
            </h5>
            <div className="small mb-4">Author: {newsdata && newsdata[(randomGenerator - 7) > 20 ? randomGenerator - 2 : randomGenerator - 7].author}
            </div>
          </div>
        </aside>
    )
