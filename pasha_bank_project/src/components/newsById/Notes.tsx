...
export const Notes = () => {
  ...
  function saveNote(dateTime: string, content: string) {
  ...
  function deleteNote(dateTime: string) {
    ...
    return (
        ...
        <div className="voice-controller">
          ...
          <div className="app">
            ...
            <button id="start-record-btn" className="m-2" title="Start Recording">Start Recognition</button>
            <button id="pause-record-btn" className="m-2" title="Pause Recording">Pause Recognition</button>
