    ...
    return (
        <div className="container-fluid w-100 covid-table covid-container">
            {countriesArray ? '' : <Backdrop className={classes.backdrop} open>
                ...
                <h3 className="loading-style">   Loading ... </h3>
            </Backdrop>}
            <CovidUi />
            <div className="row" >
                    ...
                    <div className="card shadow mb-4 covid-info-cards" id="table-card">
                        <div className="card-header d-flex justify-content-between" style={{ height: "70px" }}>
                            ...
                            <div className="w-25">
                                ...
                                <select onChange={handleItemsperPage} value={itemsPerPage} className="px-2 ml-2 bg-light text-danger py-1 border-none font-weight-bold item-per-page-select" name="itemsPerPage" id="itemsPerPage">
